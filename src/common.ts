import { MessageEmbed, TextBasedChannels, MessageOptions, Message } from "discord.js";
...
export function send(channel: TextBasedChannels | undefined, message: MessageEmbed | MessageOptions, callback?: (message: Message) => void): void {
  if (!channel) return;
